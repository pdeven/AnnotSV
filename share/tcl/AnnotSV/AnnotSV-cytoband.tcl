...
proc checkCytoband {} {
    ...
    foreach genomeBuild {GRCh37 GRCh38 T2T-CHM13} {
        ...
        set cytobandDir "$g_AnnotSV(annotationsDir)/Annotations_$g_AnnotSV(organism)/AnyOverlap/CytoBand/$genomeBuild"
        set cytobandBEDfile     "$cytobandDir/cytoBand_$genomeBuild.bed"
        set formattedFile       "$cytobandDir/cytoBand_$genomeBuild.formatted.bed"
        set formattedSortedFile "$cytobandDir/cytoBand_$genomeBuild.formatted.sorted.bed"
        set cytobandHeaderFile  "$cytobandDir/cytoBand_$genomeBuild.header.tsv"
